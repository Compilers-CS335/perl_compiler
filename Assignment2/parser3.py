...
def p_for(p):
	...
	add  += "\nforStatement_" +str(forstmtNUM)+ " -- { FOR_" +str(forNUM)+" " + "OPENPARANTHESIS_" +str(openparenthesisNUM)+ " " +p[3] + " SEMICOLON_" + str(semicolonNUM) + " " +p[5] + " SEMICOLON_" +str(semicolonNUM+1) + " " +"CLOSEPARANTHESIS_" + str(closeparenthesisNUM)+ " " +p[9] + " };"
	semicolonNUM += 1
